...
incidência de empenagem de cruzeiro ($i_t = -3{,}54^\circ$), o que resulta
em $\alpha = 5{,}43^\circ$. As derivadas longitudinais e de força lateral
...
Parâmetro & Valor & Fonte \\
\midrule
$C_{L0}$ & $-0{,}0612$ & AVL \texttt{ft} \\
$C_{M0}$ & 0,0234 & AVL \texttt{ft} \\
$C_{D0}$ & 0,01833 & ajuste do item 5.b \\
$C_{D\alpha}$ [1/rad] & $-0{,}0693$ & ajuste do item 5.b \\
$C_{D\alpha 2}$ [1/rad$^2$] & 1,5755 & ajuste do item 5.b \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
$C_{L\alpha}$ [1/rad] & 6,4758 & 6,4758 & \texttt{st} \\
$C_{Lq}$ [1/rad] & 10,9211 & 10,9211 & \texttt{st} \\
$C_{Lit}$ & 0,013811 & 0,7913 & \texttt{st}, $\times 180/\pi$ \\
$C_{L\delta e}$ & 0,007676 & 0,4398 & \texttt{st}, $\times 180/\pi$ \\
$C_{Dq}$ [1/rad] & 0,2753 & 0,2753 & dif. finita \\
$C_{Dit}$ & 0,000430 & 0,0246 & dif. finita, $\times 180/\pi$ \\
$C_{D\delta e}$ & 0,000240 & 0,0138 & dif. finita, $\times 180/\pi$ \\
$C_{M\alpha}$ [1/rad] & $-2{,}2524$ & $-2{,}2524$ & \texttt{st} \\
$C_{Mq}$ [1/rad] & $-32{,}3544$ & $-32{,}3544$ & \texttt{st} \\
$C_{Mit}$ & $-0{,}052717$ & $-3{,}0205$ & \texttt{st}, $\times 180/\pi$ \\
$C_{M\delta e}$ & $-0{,}030536$ & $-1{,}7496$ & \texttt{st}, $\times 180/\pi$ \\
$C_{Y\beta}$ [1/rad] & $-0{,}3994$ & 0,3994 & \texttt{st}, sinal invertido \\
$C_{Yp}$ [1/rad] & 0,0446 & $-0{,}0446$ & \texttt{st}, sinal invertido \\
$C_{Yr}$ [1/rad] & 0,4270 & $-0{,}4270$ & \texttt{st}, sinal invertido \\
$C_{Y\delta r}$ & $-0{,}004031$ & $-0{,}2310$ & \texttt{st}, $\times 180/\pi$ \\
$C_{\ell\beta}$ [1/rad] & $-0{,}1972$ & $-0{,}1972$ & \texttt{st} \\
$C_{\ell p}$ [1/rad] & $-0{,}5609$ & $-0{,}5609$ & \texttt{sb} \\
$C_{\ell r}$ [1/rad] & 0,1072 & 0,1072 & \texttt{sb} \\
$C_{\ell\delta a}$ & $-0{,}004189$ & 0,2400 & \texttt{sb}, sinal e $\times 180/\pi$ \\
$C_{\ell\delta r}$ & $-0{,}000503$ & 0,0288 & \texttt{sb}, sinal e $\times 180/\pi$ \\
$C_{n\beta}$ [1/rad] & 0,1753 & 0,1753 & \texttt{st} \\
$C_{np}$ [1/rad] & $-0{,}0899$ & $-0{,}0899$ & \texttt{sb} \\
$C_{nr}$ [1/rad] & $-0{,}2067$ & $-0{,}2067$ & \texttt{sb} \\
$C_{n\delta a}$ & $-0{,}000477$ & 0,0273 & \texttt{sb}, sinal e $\times 180/\pi$ \\
$C_{n\delta r}$ & 0,002186 & $-0{,}1252$ & \texttt{sb}, sinal e $\times 180/\pi$ \\
\bottomrule
\end{tabular}
\end{table}
