...
\midrule
CG dianteiro sem deflexões & 0,02829 & $+17{,}5\%$ \\
CG dianteiro compensado ($C_M = 0$) & 0,02829 & $+17{,}5\%$ \\
CG traseiro sem deflexões & 0,02630 & $+9{,}3\%$ \\
CG traseiro compensado ($C_M = 0$) & 0,02631 & $+9{,}3\%$ \\
...
compensação: o CG dianteiro paga 20 pontos de arrasto ($\Delta C_D =
0{,}0020$) a mais que o traseiro pela força para baixo adicional na
empenagem. O restante do desvio vem do arrasto induzido do modelo, que
inclui a contribuição da empenagem carregada, enquanto a polar do
\texttt{designTool} assume o fator de Oswald da asa isolada.
...
Nos casos compensados, o profundor varre de $-6{,}9^\circ$ no
$C_{L\mathrm{max}}$ a $+20{,}7^\circ$ no $C_{L\mathrm{min}} = -0{,}5$ para
o CG dianteiro, e de $-4{,}7^\circ$ a $+12{,}2^\circ$ para o traseiro,
...
discutidas na Seção 4. Em baixa velocidade a demanda cresce: no
estol trimado do CG dianteiro o profundor chega a $-10{,}7^\circ$, valor
ainda admissível, mas que reforça a recomendação de rever a margem
estática quando a fuselagem for incorporada à análise.
