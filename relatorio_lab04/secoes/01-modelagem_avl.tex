...
A asa tem torção geométrica definida por estação, resultado da otimização
apresentada na Seção~\ref{sec:torcao}, que descarrega a ponta para
controlar o local de início do estol e reduzir o arrasto induzido.
...
\begin{figure}[H]
\centering
\caption{Geometria da aeronave no AVL. Em cima, a planta com asa, empenagem
horizontal e empenagem vertical. Embaixo, a vista lateral da asa comparando
as cordas sem torção com a torção otimizada da Seção~\ref{sec:torcao}, que
evidencia o washout crescente da raiz para a ponta.}\label{fig:geometria}
\includegraphics[width=0.85\linewidth]{images/01_geometria/geometria_avl.png}
\end{figure}
