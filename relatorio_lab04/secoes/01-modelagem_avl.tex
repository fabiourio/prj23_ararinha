...
momentos. Os arquivos não foram escritos à mão. Um script
(\texttt{lab04\_gera\_avl.py}) lê a geometria convergida do
\texttt{designTool} e escreve os dois arquivos, o que garante consistência
com os Labs anteriores e reprodutibilidade da entrega.
