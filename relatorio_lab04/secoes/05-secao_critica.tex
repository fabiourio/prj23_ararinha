...
na ponta, em $\eta = 0{,}87$, sobre a região do aileron, com
$C_{L\mathrm{max}}$ entre 0,82 e 0,91. Esse diagnóstico motivou a
...
\midrule
CG dianteiro sem trimagem & 15,05 & 1,183 & 0,0 \\
CG dianteiro com trimagem & 15,11 & 1,081 & $-18{,}55$ \\
CG traseiro sem trimagem & 15,03 & 1,208 & 0,0 \\
CG traseiro com trimagem & 15,07 & 1,144 & $-11{,}68$ \\
\bottomrule
\end{tabular}
\end{table}
...
$15^\circ$, porque a distribuição de sustentação da asa quase não muda
...
com $C_{L\mathrm{max}} = 1{,}081$.

\subsection*{Características de estol}

Com a torção otimizada, a seção crítica fica em $\eta = 0{,}42$ em todos
...
Os valores de $C_{L\mathrm{max}}$, entre 1,08 e 1,21, ficam abaixo da
...
estol trimado do CG dianteiro, de $-18{,}5^\circ$, é alta mas permanece
