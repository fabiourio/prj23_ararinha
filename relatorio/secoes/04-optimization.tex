...
tolerância \texttt{ftol} $= 10^{-5}$ --- valor escolhido acima do piso de
...
A otimização convergiu em 31 avaliações do Euler, totalizando cerca de
20~minutos. Na comparação justa --- os dois perfis na \emph{mesma}
sustentação de projeto ---, o arrasto caiu de $c_d = 0{,}06705$ para
$c_d = 0{,}01164$, uma redução de $\mathbf{82{,}6\%}$. A
Figura~\ref{fig:opt_hist} mostra o histórico: a queda grande acontece nas
primeiras $\sim$15 avaliações, quando o otimizador desmonta o choque forte
...
mínima ($(t/c)_{\max} = 0{,}17720$, exatamente no limite --- o otimizador
afinaria o perfil se pudesse, pois espessura custa arrasto de onda) e a
substituta de $c_{\ell,\max}$ ($0{,}09415$ contra o limiar $0{,}0938$ --- o
otimizador afiaria o nariz se pudesse, ao custo do estol). Um batente
também terminou ativo: $A_{l4} = -0{,}05$, o coeficiente que controla o
côncavo do intradorso traseiro (\emph{cusp}); o roteiro o limita
...
um fator 2,5, convergiram todos para o mesmo ponto --- espalhamento de
...
coeficiente CST de até $\pm0{,}06$ com o $c_\ell$ re-trimado, nenhuma das 44
direções avaliadas reduz o arrasto sem violar uma restrição (a espessura
barra 24 direções, a substituta de $c_{\ell,\max}$ barra 13, e nas 7
restantes o arrasto simplesmente piora). O perfil obtido é o mínimo de
arrasto possível dada a espessura estrutural que a asa exige.
